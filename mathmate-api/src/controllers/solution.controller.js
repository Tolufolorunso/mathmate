...
import {
  solveImageProblemWithGemini,
  solveMathProblemWithGemini,
} from '../utils/gemini-api.js';
  ...
  try {
    ...
    if (type === 'text') {
      ...
      res.json({
        ...
        message: 'Solution generated by Gemini API for text',
      });
      return;
    }

    if (type === 'image') {
      const solution = await solveImageProblemWithGemini(
      ...
      res.json({
        ...
        message: 'Solution generated by Gemini API for image',
      });
      return;
    }
